...
function setupAnimation() {
    ...
    let rounded_square_svg_file = "rounded_square.svg";
    ...
    let grid_width = Math.round(width / 50);
    let grid_height = Math.round(height / 50);
    let grid = [];

    let squareSize = Math.min(width/grid_width, height/grid_height) * 0.9;
