...
let square_opacity = 0.50;
let move_speed = 0.75;
let repeat_delay = 1000;
...
function do_animation() {
    ...
    if(is_animating) timeoutId = setTimeout(do_animation, repeat_delay);
}
...
document.addEventListener("visibilitychange", function() {
    if (document.hidden) {
        ...
        is_animating = true;
        timeoutId = setTimeout(do_animation, repeat_delay/2);
    }
});